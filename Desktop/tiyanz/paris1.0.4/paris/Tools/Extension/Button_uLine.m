...
- (void)isSelected:(UIColor *)titleColor{
    self.a_title.textColor = titleColor;
    self.a_line.hidden = NO;
}

- (void)isNotSelected:(UIColor *)titleColor{
    self.a_title.textColor = titleColor;
    self.a_line.hidden = YES;
}
