...
static NSString *const PSW_AES_KEY = @"ZHWTCOMTIYANZ";
//static NSString *const AES_IV_PARAMETER = @"AES00IVPARAMETER";
static NSString *const AES_IV_PARAMETER = @"AES05ZWTIVTIYANZ";

@implementation NSString (AES)

#pragma mark - 新版
- (NSString*)aci_encryptWithKey:(NSString *)key{
...
- (NSString*)aci_decryptWithKey:(NSString *)key{
 //   NSData *data = [self dataUsingEncoding:NSUTF8StringEncoding];
